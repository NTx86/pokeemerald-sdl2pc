...
bool8 SetWindowAttribute(u8 windowId, u8 attributeId, u32 value)
{
    ...
    case WINDOW_TILE_DATA:
        DBGPRINTF("SetWindowAttribute(%d, WINDOW_TILE_DATA, %d): Use SetWindowTileDataPtr instead!\n", windowId, value);
        return FALSE;
    case WINDOW_BG:
    case WINDOW_WIDTH:
    case WINDOW_HEIGHT:
...
u32 GetWindowAttribute(u8 windowId, u8 attributeId)
{
    ...
    case WINDOW_TILE_DATA:
        DBGPRINTF("GetWindowAttribute(%d, WINDOW_TILE_DATA): Use GetWindowTileDataPtr instead!\n", windowId);
        abort();
    default:
        return 0;
    }
