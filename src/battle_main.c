...
u8 gMultiUsePlayerCursor NO_BSS;
u8 gNumberOfMovesToChoose NO_BSS;
u8 gBattleControllerData[MAX_BATTLERS_COUNT] NO_BSS; // Used by the battle controllers to store misc sprite/task IDs for each battler
